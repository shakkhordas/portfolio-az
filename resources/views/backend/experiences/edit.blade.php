        ...
        <form action="{{ route('experiences.update', $experience) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="2"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring">{{ old('description', $experience->description) }}</textarea>
            </div>
            <div class="mb-4">
                <label for="link" class="block text-sm font-medium mb-1">Link</label>
                <input type="url" id="link" name="link"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring"
                    value="{{ old('link', $experience->link) }}" />
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <label class="inline-flex items-center mr-4">
                    <input type="radio" name="current" value="1" class="form-radio"
                        {{ old('current', $experience->current) == 1 ? 'checked' : '' }} />
                    <span class="ml-2">Yes</span>
                </label>
                <label class="inline-flex items-center">
                    <input type="radio" name="current" value="0" class="form-radio"
                        {{ old('current', $experience->current) == 0 ? 'checked' : '' }} />
            ...
            <div class="mb-4">
                ...
                <textarea id="achievements" name="achievements" rows="2"
                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring">{{ old('achievements', $experience->achievements) }}</textarea>
            </div>
